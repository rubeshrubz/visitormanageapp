...
import { Button, View,StyleSheet, Text, TouchableOpacity ,Image,FlatList} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  cardTitletext:{
    fontSize:17,color:'#2D2B89',fontWeight:'800',width:'80%'
  },
  subtext: {
    fontSize: 16,
    fontWeight: 'bold',
  ...
  textStyle:{
    fontWeight:'500',color:'700',fontSize:14
  }
})
